...
function HealthBenfits() {
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="flex flex-col items-center my-12 px-4 md:px-6 lg:px-8">
        <article className="max-w-screen bg-white rounded-2xl p-10 md:p-8 text-[#232323] leading-relaxed text-[1.05rem] md:text-[1rem]">
          <h2 className="text-2xl font-bold mb-6 text-[#b9461b]">Health Benefits of Guru Food Products</h2>

          {/* Pickles */}
          <section className="mb-10">
            <h3 className="text-xl font-semibold mb-4 text-[#d44c23]">1. Pickles</h3>
            <ul className="list-disc list-inside space-y-2">
              <li><strong>Probiotics:</strong> Naturally fermented pickles are rich in probiotics, which promote gut health and aid digestion.</li>
              <li><strong>Nutrient-Rich:</strong> Pickles made from fresh vegetables and fruits retain essential vitamins and minerals, contributing to a balanced diet.</li>
              <li><strong>Antioxidants:</strong> Many pickles contain spices like turmeric and mustard seeds, known for their antioxidant properties.</li>
              <li><strong>Low-Calorie Snack:</strong> A flavorful, low-calorie option to enhance meals without adding excess calories.</li>
            </ul>
          </section>

          {/* Sauces */}
          <section className="mb-10">
            <h3 className="text-xl font-semibold mb-4 text-[#d44c23]">2. Sauces</h3>
            <ul className="list-disc list-inside space-y-2">
              <li><strong>Flavor Enhancement:</strong> Enhances the taste of healthy meals, encouraging the intake of vegetables and whole foods.</li>
              <li><strong>Nutrient Absorption:</strong> Sauces with healthy fats improve absorption of fat-soluble vitamins (A, D, E, K).</li>
              <li><strong>Customizable Nutrition:</strong> Can be crafted with wholesome ingredients and minimal additives for health-conscious consumers.</li>
            </ul>
          </section>

          {/* Sharbats */}
          <section className="mb-10">
            <h3 className="text-xl font-semibold mb-4 text-[#d44c23]">3. Sharbats</h3>
            <ul className="list-disc list-inside space-y-2">
              <li><strong>Hydration:</strong> A refreshing way to stay hydrated, especially in hot weather.</li>
              <li><strong>Vitamins and Minerals:</strong> Real fruit content provides essential nutrients, like vitamin C, for overall wellness.</li>
              <li><strong>Natural Sweetness:</strong> A healthier alternative to sugary drinks, with reduced intake of refined sugars.</li>
              <li><strong>Digestive Benefits:</strong> Certain varieties contain herbs and spices that support digestive health.</li>
            </ul>
          </section>

          {/* Murabbas */}
          <section className="mb-10">
            <h3 className="text-xl font-semibold mb-4 text-[#d44c23]">4. Murabbas</h3>
            <ul className="list-disc list-inside space-y-2">
              <li><strong>Natural Energy Boost:</strong> Made from fruits, murabbas provide quick, natural energy.</li>
              <li><strong>Rich in Fiber:</strong> Promotes digestion and helps with maintaining a healthy weight.</li>
              <li><strong>Antioxidant Properties:</strong> Helps reduce inflammation and supports overall health.</li>
              <li><strong>Traditional Remedies:</strong> Often prepared with herbs and spices that offer wellness benefits rooted in traditional practices.</li>
            </ul>
          </section>

          {/* Overall */}
          <section>
            <h3 className="text-xl font-semibold mb-4 text-[#d44c23]">Overall Health Benefits</h3>
            <ul className="list-disc list-inside space-y-2">
              <li><strong>Balanced Diet:</strong> Incorporates various nutrients and flavors into everyday meals.</li>
              <li><strong>Cultural Connection:</strong> Strengthens mental well-being by connecting with tradition and family heritage.</li>
              <li><strong>Convenience:</strong> Offers quick, nutritious options to enhance daily meals without compromising on health.</li>
            </ul>
          </section>
        </article>
      </main>
